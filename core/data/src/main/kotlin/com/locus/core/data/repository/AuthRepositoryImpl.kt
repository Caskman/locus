...
import aws.sdk.kotlin.services.cloudformation.*
...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun validateBucket(bucketName: String): LocusResult<BucketValidationStatus> {
        ...
        _provisioningState.value = ProvisioningState.ValidatingBucket
    ...
    override suspend fun recoverAccount(bucketName: String, deviceName: String): LocusResult<RuntimeCredentials> {
         val credsResult = secureStorage.getBootstrapCredentials()
        val creds = (credsResult as? LocusResult.Success)?.data
            ?: return LocusResult.Failure(DomainException.AuthError.InvalidCredentials)
